...
tools: Read, Write, Edit, Bash, Glob, Grep, Skill(exploratory-data-analysis), Skill(statistical-analysis), Skill(scikit-learn), Skill(pytorch-lightning), Skill(literature-review)
model: sonnet
---
